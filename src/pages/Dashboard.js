...
function Dashboard(props) {
  ...
  const earningsInDollars = tokenVolume == 0 ? 0 : (holdings / 5000000000) * (tokenVolume * 0.10)
            ...
            <div className="items-center justify-middle text-center">   
              ...
              onClick={() => {
                if (wallet !== null && dividendContract !== null) {
                  const encodedABI = dividendContract.interface.encodeFunctionData('claimDividend', [])
